		...
		return (
			<div className="App">
				...
				<div className="app-body">
					...
					I follow the guidelines from this very <a href="https://blog.apastyle.org/apastyle/2017/05/whats-in-a-name-two-part-surnames-in-apa-style.html" target="_blank">comprenhensive guide</a>. 
